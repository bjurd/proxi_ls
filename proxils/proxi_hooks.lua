...
---
---
--- @overload fun(eventName: "PreFrameStageNotify", identifier: any, func: fun(stage: number))
--- @overload fun(eventName: "PostFrameStageNotify", identifier: any, func: fun(stage: number))
--- @overload fun(eventName: "CreateMoveEx", identifier: any, func: fun(command: CUserCmd, bSendPacket: boolean): boolean|nil, boolean|nil)
--- @overload fun(eventName: "DispatchEffect", identifier: any, func: fun(szEffectName: string, m_Data: CEffectData): boolean|nil)
--- @overload fun(eventName: "OutgoingNetMessage", identifier: any, func: fun(bf_read: proxiBFRead): boolean|nil)
